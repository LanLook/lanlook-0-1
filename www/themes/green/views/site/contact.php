...
<p><?php echo Yii::t('msg', 'If you have business inquiries or other questions, please fill out the following form to contact us. Thank you.'); ?></p>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton('Submit', array('class'=>'ui-button')); ?>
	</div>
